...
namespace aie
{
	...
	void Application::BeginPlay()
	{
		...
		float* data = new float[] { 0, 0, 0, 4, 0, 0, 0, 1, 2, 2, 2, 0, 2, 2,
			0, 0, 0, 4, 0, 0, 1, 1, 2, 2, 2, 0, 2, 2,
			0, 0, 4, 4, 0, 0, 0, 1, 0, 0, 2, 2, 2, 2,
			1, 0, 4, 0, 0, 0, 0, 1, 1, 2, 2, 2, 2, 2,
			1, 1, 4, 0, 0, 0, 2, 1, 1, 2, 1, 1, 2, 2,
			1, 0, 4, 0, 2, 2, 0, 0, 0, 1, 1, 0, 2, 2,
			2, 0, 2, 4, 2, 0, 0, 0, 0, 0, 0, 0, 2, 2,
			2, 2, 2, 0, 4, 4, 0, 0, 0, 0, 0, 0, 2, 2,
			2, 2, 1, 0, 0, 4, 0, 0, 0, 0, 0, 0, 2, 2,
			2, 1, 0, 0, 0, 0, 4, 0, 0, 0, 0, 1, 2, 2,
			2, 2, 0, 0, 0, 0, 4, 4, 1, 0, 2, 2, 2, 2,
			1, 0, 0, 0, 0, 1, 1, 4, 4, 0, 2, 2, 2, 2,
			1, 0, 0, 1, 1, 0, 1, 1, 4, 0, 1, 1, 2, 2,
			1, 1, 0, 1, 0, 0, 0, 0, 4, 0, 0, 0, 2, 2 };
